 ...
 * @constructor
 *
 * @param {Object} opts options for the Analog Sensor
 * @property {Number} upperLimit The upper value limit the sensor will read
 * @property {Number} lowerLimit The lower value limit the sensor will read
 * @property {Number} analogVal The latest value read from the sensor
 */
