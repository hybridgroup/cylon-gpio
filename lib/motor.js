 ...
 * @constructor
 *
 * @param {Object} opts options for the motor
 * @property {Boolean} isOn whether the motor is currently on or not
 * @property {Number} speedValue the current speed of the motor
 * @property {Object} pwmScale the PWM scale top/bottom. defaults to 0/255
 */
