...
/**
 * An IR Range Sensor driver
 *
 * @constructor
 *
 * @param {Object} opts options for the Continous Servo
 * @property {Number} analogVal analog value returned by sensor
 * @property {Number} distanceCm calculated distance in centimeters
 * @property {Number} distanceIn calculated distance in inches
 */
