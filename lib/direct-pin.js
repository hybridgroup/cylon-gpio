...
DirectPin.prototype.digitalWrite = function(value) {
  this.adaptor.digitalWrite(this.pin, value);
};
...
DirectPin.prototype.digitalRead = function(callback) {
  if (!this.dReadSet) {
    this.adaptor.digitalRead(this.pin, callback);
  }
  this.dReadSet = true;
};
...
DirectPin.prototype.analogWrite = function(value) {
  this.adaptor.analogWrite(this.pin, value);
};
...
DirectPin.prototype.analogRead = function(callback) {
  if (!this.aReadSet) {
    this.adaptor.analogRead(this.pin, callback);
  }
  this.aReadSet = true;
};
// Public: ServoWrite
...
DirectPin.prototype.servoWrite = function(angle) {
  return this.adaptor.servoWrite(this.pin, angle);
};
...
DirectPin.prototype.pwmWrite = function(value) {
  return this.adaptor.pwmWrite(this.pin, value);
};
