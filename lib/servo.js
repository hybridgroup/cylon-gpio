 ...
 * @constructor
 *
 * @param {Object} opts options for the Servo
 * @property {Number} angleValue the current angle of the servo
 * @property {Object} range the min/max usable range of the servo, default 20/160
 */
